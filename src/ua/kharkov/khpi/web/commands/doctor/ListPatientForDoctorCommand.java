...
public class ListPatientForDoctorCommand extends Command {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("Commands \"ListPatientForDoctorCommand\" starts");
		...
		// check the role
		log.debug("request.getSession(false).getAttribute(\"userRole\"):" + request.getSession(false).getAttribute("userRole"));
		log.debug("request.getSession(false).getAttribute(\"userRole\").equals(Role.ADMIN):" + request.getSession(false).getAttribute("userRole").equals(Role.ADMIN));
